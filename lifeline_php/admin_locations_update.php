            ...
            <form action="includes/locations_update.inc.php" class="ui form" method="post">
                        ...
                        <div class="two fields">
                            ...
                            <div class="field"style="width:80%">
                                ...
                                <div class="field">
                                    <input type="text" name="hospitalname" placeholder="Name of Hospital" value="<?php echo $hospitalname; ?>" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="two fields">
                            <div class="field">
                                ...
                                <div class="field">
                                    <input type="time" name="from" placeholder="From" value="<?php echo $hours_from; ?>">
                                </div>
                            </div>
                            <div class="field">
                                <label>until</label>
                                <div class="field">
                                    <input type="time" name="to" placeholder="To" value="<?php echo $hours_to; ?>">
                                </div>
                            </div>
                        </div>
                    ...
                    <h4 class="ui dividing header" style="color:#E50914">Contact Information</h4>
                        ...
                        <div class="field">
                                ...
                                <div class="field">
                                    <textarea style="resize:none; height:30px"  name="address" required ><?php echo $address; ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="two fields" >
                            ...
                            <div class="field">
                                ...
                                <div class="field">
                                    <input type="text" name="contactnum" value="<?php echo $contactnum; ?>"  placeholder="Contact Number/s" required>
                                </div>
                            </div>
                        </div>
