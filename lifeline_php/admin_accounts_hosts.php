<?php
  ...
  $result1= mysqli_query($conn, "SELECT COUNT(id) AS count FROM host");
  $row1 = mysqli_fetch_assoc($result1); 
  $count1 = $row1['count'];

  $result2 = mysqli_query($conn, "SELECT COUNT(id) AS count FROM drive ");
  ...
  $results = mysqli_query($conn, "SELECT * FROM host");
  $dCount = $count1;
?>
    ...
    <div class="content" style="position: absolute; top:50%; transform: translateY(-56%);
            ...
            <div class="ui three cards"  style="width:100%; margin:auto; z-index:0">
              ...
              <div class="card">
                <div class="content">
                  <div class="left floated ui image">
                    <i class="user md green icon" style="font-size: 20px"></i> 
                  </div>
                  <div class="header">
                        <?php echo $count2; ?>
                  </div>
                        ...
                        <?php while ($row = mysqli_fetch_array($results)) { ?>
                            <tr>
                                <td data-label="Name" style="width:80px">
                                  <a href="admin_accounts_hosts_view.php?view=<?php echo $row['id']; ?>" target="_self">
                                    <b>
                                      <?php echo $row['name']; ?>
                                    </b>
                                  </a>
                                ...
                                <td data-label="Contacts" style="width:80px">
                                  <?php echo $row['email']; ?>
                                  <br>
                                  <?php echo $row['phonenum']; ?>
                                </td>
                                <td data-label="Organization" style="width:180px">
                                    <br>
                                    <?php echo $row['orgname']; ?>
                                    <br>
                                    <?php echo $row['orgtype']; ?>
                                </td>
                                <td data-label="Actions" style="text-align:center">
                                        <a href="admin_accounts_hosts_list.php?view=<?php echo $row['id']; ?>" target="_self">
